...
let myPhone = iOSDeviceType1.iPhone("8+")
...
func getPosition(startingAt: (Int,Int), startAt: [Step]) -> (Int,Int) {
    var x = 0
    var y = 0
...
let endPosition = getPosition(startingAt: startingLocation, startAt: steps)
